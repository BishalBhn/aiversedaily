(function () {
    ...
    { id: "tutorials", label: "Tutorials", icon: "🛠",
      ...
      lists: [{ path: "tutorials.items", title: "Tutorial cards", addLabel: "Add tutorial", nameKey: "title",
        fields: [
          { key: "title", label: "Title", type: "text" },
          { key: "excerpt", label: "Excerpt", type: "textarea" },
          { key: "level", label: "Level", type: "text", half: true },
          { key: "levelColor", label: "Level colour", type: "select", options: TAG, half: true },
          { key: "duration", label: "Duration", type: "text", half: true },
          { key: "requires", label: "Requires", type: "text", half: true }
        ] }] },
  ...
  document.getElementById("btnPublish").onclick = function () {
    var header = "/* AIVERSE DAILY — content source of truth. Generated by the CMS. */\n";
    download("content.js", header + "window.AIVERSE_CONTENT = " + JSON.stringify(data, null, 2) + ";\n");
    toast("Downloaded content.js — replace it on your site to publish.");
  };
